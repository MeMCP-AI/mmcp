...
pub use engine::{
    ...
    PushReport, PushScope, PushTransportError, PushedGroup, RemoteManifestFailure,
    RemotePushOutcome, RemoteTransport, SyncEngine, SyncReport, run_bounded,
};
pub use error::{IndexContended, SyncError};
